...
if [ -z "$OMARCHY_BARE" ]; then
  ...
  omarchy-webapp-install "Jira" https://datapizza.atlassian.net/jira/software/c/projects/DT/boards/5 https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/atlassian-jira.png
  omarchy-webapp-install "Calendar" https://app.usemotion.com/web/calendar https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/google-calendar.png
  omarchy-webapp-install "Mail" https://mail.google.com/mail/u/0/ https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/gmail.png
  omarchy-webapp-install "Omarchy Manual" https://manuals.omamix.org/2/the-omarchy-manual https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/arch-linux.png
